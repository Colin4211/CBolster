...
//
//  File:
//      CBolster\Libraries\CBBase\CBBase_Integers.h
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#ifndef _CBBase_Integers_h
#define _CBBase_Integers_h
    ...
    class  Integer_CONSTANT
{
    ...
    public:
        CBOLSTER_CONSTEXPR_DECLARE Integer_CONSTANT( const char * pszString )
            : m_ResultVal( get_value(pszString) )
        {
            return;
        }
        CBOLSTER_CONSTEXPR_DECLARE  T_INT_TYPE  value( void ) const { return (m_ResultVal); };
    private:
        CBOLSTER_CONSTEXPR_DECLARE  T_INT_TYPE  get_value( const char * pszString )
        {
            T_INT_TYPE resultVal = 0;
            {
                if ( pszString != NULL )
                {
                    ...
                    if ( fNeg == true )
                    {
                        CBOLSTER_CONSTEXPR_DECLARE  T_INT_TYPE   minusOne = 0 - 1;
    ...
    class  Integer_INFO
{
    ...
    public:
        CBOLSTER_CONSTEXPR_DECLARE  Integer_INFO( const T_INT_TYPE & dummyNumber )
        ...
        CBOLSTER_CONSTEXPR_DECLARE size_t        size_bytes( void ) const    { return (m_SizeBytes);     };
        CBOLSTER_CONSTEXPR_DECLARE size_t        size_bits( void ) const     { return (m_SizeBits);      };
        CBOLSTER_CONSTEXPR_DECLARE bool          signed_type( void ) const   { return (m_fSignedType);   };
        CBOLSTER_CONSTEXPR_DECLARE T_INT_TYPE    min_value( void ) const     { return (m_MinValue);      };
        CBOLSTER_CONSTEXPR_DECLARE T_INT_TYPE    max_value( void ) const     { return (m_MaxValue);      };

    private:
        CBOLSTER_CONSTEXPR_DECLARE   bool    get_signed_type( void )
            {
                T_INT_TYPE nValue = 0;
                nValue--;
                return ( (nValue > 0) ? false : true );
            };
        CBOLSTER_CONSTEXPR_DECLARE   T_INT_TYPE  get_min_value( void )
            {
                T_INT_TYPE resultVal = 0;
        ...
        CBOLSTER_CONSTEXPR_DECLARE  T_INT_TYPE  get_max_value( void )
            {
                T_INT_TYPE resultVal = 0;
                if ( get_signed_type() == false )
                {
...
//  Uint8 - Int8
...
#endif // defined(CBOLSTER_PLATFORM_TYPE_MSWIN32)
    ...
    namespace CBBase
    {
        ...
        #define Uint8_MIN                           (CBBase::Uint8_INFO.min_value())
    #endif // !defined(Uint8_MIN)

    #if !defined(Uint8_MAX)
        #define Uint8_MAX                           (CBBase::Uint8_INFO.max_value())
    #endif // !defined(Uint8_MAX)

    #if !defined(Uint8_CONSTANT)
        #define Uint8_CONSTANT(NUMBER)              (CBBase::Integer_CONSTANT<Uint8>(#NUMBER).value())
    ...
    #if !defined(Int8_MIN)
        #define Int8_MIN                            (CBBase::Int8_INFO.min_value())
    #endif // !defined(Int8_MIN)

    #if !defined(Int8_MAX)
        #define Int8_MAX                            (CBBase::Int8_INFO.max_value())
    #endif // !defined(Int8_MAX)

    #if !defined(Int8_CONSTANT)
        #define Int8_CONSTANT(NUMBER)               (CBBase::Integer_CONSTANT<Int8>(#NUMBER).value())
...
//  Uint16 - Int16
    ...
    namespace CBBase
    {
        ...
        #define Uint16_MIN                          (CBBase::Uint16_INFO.min_value())
    #endif // !defined(Uint16_MIN)

    #if !defined(Uint16_MAX)
        #define Uint16_MAX                          (CBBase::Uint16_INFO.max_value())
    #endif // !defined(Uint16_MAX)

    #if !defined(Uint16_CONSTANT)
        #define Uint16_CONSTANT(NUMBER)             (CBBase::Integer_CONSTANT<Uint16>(#NUMBER).value())
    ...
    namespace CBBase
    {
        ...
        #define Int16_MIN                           (CBBase::Int16_INFO.min_value())
    #endif // !defined(Int16_MIN)

    #if !defined(Int16_MAX)
        #define Int16_MAX                           (CBBase::Int16_INFO.max_value())
    #endif // !defined(Int16_MAX)

    #if !defined(Int16_CONSTANT)
        #define Int16_CONSTANT(NUMBER)              (CBBase::Integer_CONSTANT<Int16>(#NUMBER).value())
...
//  Uint32 - Int32
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Uint32>      Uint32_INFO;
    }

    #if !defined(Uint32_MIN)
        #define Uint32_MIN                          (CBBase::Uint32_INFO.min_value())
    #endif // !defined(Uint32_MIN)

    #if !defined(Uint32_MAX)
        #define Uint32_MAX                          (CBBase::Uint32_INFO.max_value())
    #endif // !defined(Uint32_MAX)

    #if !defined(Uint32_CONSTANT)
        #define Uint32_CONSTANT(NUMBER)             (CBBase::Integer_CONSTANT<Uint32>(#NUMBER).value())
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Int32>       Int32_INFO;
    }

    #if !defined(Int32_MIN)
        #define Int32_MIN                           (CBBase::Int32_INFO.min_value())
    #endif // !defined(Int32_MIN)

    #if !defined(Int32_MAX)
        #define Int32_MAX                           (CBBase::Int32_INFO.max_value())
    #endif // !defined(Int32_MAX)

    #if !defined(Int32_CONSTANT)
        #define Int32_CONSTANT(NUMBER)              (CBBase::Integer_CONSTANT<Int32>(#NUMBER).value())
...
//  Uint64 - Int64
...
#endif // defined(CBOLSTER_PLATFORM_TYPE_MSWIN64)
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Uint64>      Uint64_INFO;
    }

    #if !defined(Uint64_MIN)
        #define Uint64_MIN                          (CBBase::Uint64_INFO.min_value())
    #endif // !defined(Uint64_MIN)

    #if !defined(Uint64_MAX)
        #define Uint64_MAX                          (CBBase::Uint64_INFO.max_value())
    #endif // !defined(Uint64_MAX)

    #if !defined(Uint64_CONSTANT)
        #define Uint64_CONSTANT(NUMBER)             (CBBase::Integer_CONSTANT<Uint64>(#NUMBER).value())
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Int64>       Int64_INFO;
    }

    #if !defined(Int64_MIN)
        #define Int64_MIN                           (CBBase::Int64_INFO.min_value())
    #endif // !defined(Int64_MIN)

    #if !defined(Int64_MAX)
        #define Int64_MAX                           (CBBase::Int64_INFO.max_value())
    #endif // !defined(Int64_MAX)

    #if !defined(Int64_CONSTANT)
        #define Int64_CONSTANT(NUMBER)              (CBBase::Integer_CONSTANT<Int64>(#NUMBER).value())
...
//  Uint128 - Int128
...
#elif  defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM32)

    // 128bit int not supported on Linux_ARM32

#elif  defined(CBOLSTER_PLATFORM_TYPE_LINUX_I32)
...
#endif // defined(CBOLSTER_PLATFORM_TYPE_MSWIN128)
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Uint128>      Uint128_INFO;
    }

    #if !defined(Uint128_MIN)
        #define Uint128_MIN                          (CBBase::Uint128_INFO.min_value())
    #endif // !defined(Uint128_MIN)

    #if !defined(Uint128_MAX)
        #define Uint128_MAX                          (CBBase::Uint128_INFO.max_value())
    #endif // !defined(Uint128_MAX)

    #if !defined(Uint128_CONSTANT)
        #define Uint128_CONSTANT(NUMBER)             (CBBase::Integer_CONSTANT<Uint128>(#NUMBER).value())
    ...
    namespace CBBase
    {
        extern const CBBase::Integer_INFO<Int128>       Int128_INFO;
    }

    #if !defined(Int128_MIN)
        #define Int128_MIN                           (CBBase::Int128_INFO.min_value())
    #endif // !defined(Int128_MIN)

    #if !defined(Int128_MAX)
        #define Int128_MAX                           (CBBase::Int128_INFO.max_value())
    #endif // !defined(Int128_MAX)

    #if !defined(Int128_CONSTANT)
        #define Int128_CONSTANT(NUMBER)              (CBBase::Integer_CONSTANT<Int128>(#NUMBER).value())
