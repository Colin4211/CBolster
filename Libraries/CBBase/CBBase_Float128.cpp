...
//
//  File:
//      CBolster\Libraries\CBBase\CBBase_Float128.cpp
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#if defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM64)

/////////////////////////////////////////////////////////////////////////////

tagFloat128_Info::tagFloat128_Info( void )
{
    clear();
    return;
}
...
tagFloat128_Info::tagFloat128_Info( const float_type & theFloat )
    : m_Float( theFloat )
{
    validate();
    return;
...
tagFloat128_Info::tagFloat128_Info( const char & initChar )
{
    clear();
...
tagFloat128_Info::tagFloat128_Info( const byte_type & byte0, const byte_type & byte1, const byte_type & byte2, const byte_type & byte3,
...
tagFloat128_Info::operator Float128( void ) const
{
    return (m_Float);
}
...
const  tagFloat128_Info::float_type &  tagFloat128_Info::operator = ( const float_type & rhSide )
{
    m_Float = rhSide;
    validate();
    return (m_Float);
...
void  tagFloat128_Info::clear( void )
{
    m_Uint  = 0;
    validate();
    return;
...
const char *  tagFloat128_Info::float_type_name( void ) const
{
    return ("Float128");
}
...
void  tagFloat128_Info::validate( void )
{
    return;
}
...
tagFloat128_Info::float_type  tagFloat128_Info::get_float( void ) const
{
    return (m_Float);
}
...
void  tagFloat128_Info::set_float( const float_type & theFloat, bool fValidate /*= true*/ )
{
    m_Float = theFloat;
    if ( fValidate != false )
    {
...
void  tagFloat128_Info::set_nan( bool fPositive /*= true*/ )
{
    clear();
...
void  tagFloat128_Info::set_infinity( bool fPositive /*= true*/ )
{
    clear();
    m_WideBits.m_Exponent   = 0x07FFF;
...
void  tagFloat128_Info::set_zero( bool fPositive /*= true*/ )
{
    clear();
    set_sign( fPositive );
    validate();
...
tagFloat128_Info::byte_type  tagFloat128_Info::get_byte( size_t nIndex ) const
{
...
tagFloat128_Info::byte_type  tagFloat128_Info::get_byte_mantissa( size_t nIndex ) const
{
    byte_type resultVal = 0;
    ...
    else if ( nIndex ==  8 )    {   resultVal = m_Bits.m_Mantissa08;    }
    else if ( nIndex ==  9 )    {   resultVal = m_Bits.m_Mantissa09;    }
    else if ( nIndex == 10 )    {   resultVal = m_Bits.m_Mantissa10;    }
    else if ( nIndex == 11 )    {   resultVal = m_Bits.m_Mantissa11;    }
    else if ( nIndex == 12 )    {   resultVal = m_Bits.m_Mantissa12;    }
    else if ( nIndex == 13 )    {   resultVal = m_Bits.m_Mantissa13;    }
    return (resultVal);
}

/////////////////////////////////////////////////////////////////////////////

tagFloat128_Info::byte_type  tagFloat128_Info::get_byte_exponent( size_t nIndex ) const
{
    byte_type resultVal = 0;
    if ( nIndex == 0 )
    {
...
FloatClass  tagFloat128_Info::get_float_class( void ) const
{
...
bool  tagFloat128_Info::set_byte( size_t nIndex, const byte_type & theByte )
{
...
bool  tagFloat128_Info::set_byte_mantissa( size_t nIndex, const byte_type & theByte )
{
    ...
    else if ( nIndex ==  8 )    {   m_Bits.m_Mantissa08 = theByte;  return (true); }
    else if ( nIndex ==  9 )    {   m_Bits.m_Mantissa09 = theByte;  return (true); }
    else if ( nIndex == 10 )    {   m_Bits.m_Mantissa10 = theByte;  return (true); }
    else if ( nIndex == 11 )    {   m_Bits.m_Mantissa11 = theByte;  return (true); }
    else if ( nIndex == 12 )    {   m_Bits.m_Mantissa12 = theByte;  return (true); }
    else if ( nIndex == 13 )    {   m_Bits.m_Mantissa13 = theByte;  return (true); }
    return (false);
}

/////////////////////////////////////////////////////////////////////////////

bool  tagFloat128_Info::set_byte_exponent( size_t nIndex, const byte_type & theByte )
{
...
bool  tagFloat128_Info::set_sign( bool fPositive )
{
...
tagFloat128_Info::float_type  tagFloat128_Info::get_ieee_float( void ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
        return (m_IEEE.d);
    #else
        return (Float128_CONSTANT(0));
    #endif
}

/////////////////////////////////////////////////////////////////////////////

unsigned int  tagFloat128_Info::get_ieee_mantissa( size_t nIndex ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
             if ( nIndex == 0 )  {   return (m_IEEE.ieee.mantissa0);    }
        else if ( nIndex == 1 )  {   return (m_IEEE.ieee.mantissa1);    }
        else if ( nIndex == 2 )  {   return (m_IEEE.ieee.mantissa2);    }
        else if ( nIndex == 3 )  {   return (m_IEEE.ieee.mantissa3);    }
        return (0);
    #else
        return (0);
    #endif
...
unsigned int  tagFloat128_Info::get_ieee_exponent( size_t nIndex ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
...
unsigned int  tagFloat128_Info::get_ieee_sign( void ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
...
size_t  tagFloat128_Info::get_ieee_mantissa_count( void ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
        return (4);
    #else
...
size_t  tagFloat128_Info::get_ieee_exponent_count( void ) const
{
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
        return (1);
    #else
...
#endif // defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM64)
