...
//
//  File:
//      CBolster\Libraries\CBBase\CBBase_Float64.h
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#ifndef _CBBase_Float64_h_
#define _CBBase_Float64_h_
...
typedef union tagFloat64_Info
{
    ...
    public:
        ...
        CBOLSTER_CONSTEXPR_FUNCTION  float_type      get_limits_min( void ) const                {   return (DBL_MIN);                   };
        CBOLSTER_CONSTEXPR_FUNCTION  float_type      get_limits_max( void ) const                {   return (DBL_MAX);                   };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_min_exp( void ) const            {   return (DBL_MIN_EXP);               };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_max_exp( void ) const            {   return (DBL_MAX_EXP);               };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_min_10_exp( void ) const         {   return (DBL_MIN_10_EXP);            };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_max_10_exp( void ) const         {   return (DBL_MAX_10_EXP);            };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_mantissa_digits( void ) const    {   return (DBL_MANT_DIG);              };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_digits( void ) const             {   return (DBL_DIG);                   };
...
#if defined(CBOLSTER_PLATFORM_TYPE_MSWIN_I32) || defined(CBOLSTER_PLATFORM_TYPE_MSWIN_I64) || defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM32)
    template <>
...
#endif // defined(CBOLSTER_PLATFORM_TYPE_MSWIN_I32)
