...
//
//  File:
//      CBolster\Libraries\CBBase\CBBase_Floats.h
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#ifndef _CBBase_Floats_h
#define _CBBase_Floats_h

/////////////////////////////////////////////////////////////////////////////

#if defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM32)
...
#elif defined(CBOLSTER_PLATFORM_TYPE_LINUX_ARM64)
    #define CEXBASE_FLOATS_HAS_IEEE
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
    ...
    #endif // defined(CEXBASE_FLOATS_HAS_IEEE)
#elif defined(CBOLSTER_PLATFORM_TYPE_LINUX_I64)
    #define CEXBASE_FLOATS_HAS_IEEE
    #if defined(CEXBASE_FLOATS_HAS_IEEE)
        #include <x86_64-linux-gnu/ieee754.h>
    #endif // defined(CEXBASE_FLOATS_HAS_IEEE)
#endif // defined(CBOLSTER_PLATFORM_FAMILY_LINUX)
...
//      |   {
//      |       typename CBBase::Float_Types<T_FLOAT>::float_info_type floatInfo;
...
//      as part of CBBase namespace.  This union allows direct access
...
#include "CBBase_Float32.h"
#include "CBBase_Float64.h"
#include "CBBase_Float80_I32.h"
#include "CBBase_Float80_I64.h"
#include "CBBase_Float128.h"

/////////////////////////////////////////////////////////////////////////////

#endif  // _CBBase_Floats_h
