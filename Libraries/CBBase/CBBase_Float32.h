...
//
//  File:
//      CBolster\Libraries\CBBase\CBBase_Float32.h
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#ifndef _CBBase_Float32_h_
#define _CBBase_Float32_h_
...
#define Float32_SIZEOF              (sizeof(Float32))
#define Float32_CONSTANT(nVal)      (static_cast<Float32>(nVal))

namespace CBBase
{

typedef union tagFloat32_Info
{
    // Constants
    private:
        static const size_t     bitsize_manitissa   = 23;
        static const size_t     bitsize_exponent    = 8;
        static const size_t     bitsize_sign        = 1;
        static const size_t     bitsize_extra       = 0;
        static const size_t     bitsize_total       = 32;
        static const size_t     bitsize_empty       = 0;
        static const size_t     bitsize             = 32 + 0;
    ...
    public:
        ...
        struct {
            byte_type       m_Mantissa0 :   8;
            byte_type       m_Mantissa1 :   8;
            byte_type       m_Mantissa2 :   7;
            byte_type       m_Exponent0 :   1;
            byte_type       m_Exponent1 :   7;
            byte_type       m_Sign      :   1;
        } m_Bits;
        uint_type           m_Uint;
        struct {
    ...
    //  IEEE union definitions.  (Typically only on GNU compilers)
        ...
        typedef ieee754_float   ieee_union_type;
        ieee_union_type         m_IEEE;
    #endif // defined(CEXBASE_FLOATS_HAS_IEEE)

    // Construction
    public:
        tagFloat32_Info( void );
        tagFloat32_Info( const float_type & theFloat );
        explicit tagFloat32_Info( const char & initChar );
        tagFloat32_Info( const byte_type & byte0, const byte_type & byte1, const byte_type & byte2, const byte_type & byte3 );
    ...
    public:
        ...
        bool            is_exponent_ones( void ) const      {   return (m_WideBits.m_Exponent==0x0FF);              };
        ...
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_mantissa( void ) const          {   return (bitsize_manitissa);         };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_exponent( void ) const          {   return (bitsize_exponent);          };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_sign( void ) const              {   return (bitsize_sign);              };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_extra( void ) const             {   return (bitsize_extra);             };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_total( void ) const             {   return (bitsize_total);             };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize_empty( void ) const             {   return (bitsize_empty);             };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bitsize( void ) const                   {   return (bitsize);                   };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bytesize( void ) const                  {   return (bytesize);                  };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bytesize_mantissa( void ) const         {   return ((bitsize_manitissa+7)/8);   };
        CBOLSTER_CONSTEXPR_FUNCTION  size_t          get_bytesize_exponent( void ) const         {   return ((bitsize_exponent+7)/8);    };

        CBOLSTER_CONSTEXPR_FUNCTION  float_type      get_limits_min( void ) const                {   return (FLT_MIN);                   };
        CBOLSTER_CONSTEXPR_FUNCTION  float_type      get_limits_max( void ) const                {   return (FLT_MAX);                   };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_min_exp( void ) const            {   return (FLT_MIN_EXP);               };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_max_exp( void ) const            {   return (FLT_MAX_EXP);               };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_min_10_exp( void ) const         {   return (FLT_MIN_10_EXP);            };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_max_10_exp( void ) const         {   return (FLT_MAX_10_EXP);            };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_mantissa_digits( void ) const    {   return (FLT_MANT_DIG);              };
        CBOLSTER_CONSTEXPR_FUNCTION  int             get_limits_digits( void ) const             {   return (FLT_DIG);                   };
...
template <>
    class Float_Types< Float32 >
    {
        public:
        typedef Float32         float_type;
        typedef Float32_Info    float_info_type;
        Float_Types( void ) { return; };
    };

template <>
    class Float_Types< Float32_Info >
    {
        public:
        typedef Float32         float_type;
        typedef Float32_Info    float_info_type;
...
#endif // defined(CBOLSTER_PLATFORM_FAMILY_LINUX) || defined(CBOLSTER_PLATFORM_FAMILY_MSWIN)

#endif // _CBBase_Float32_h_
